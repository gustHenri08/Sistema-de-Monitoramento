...
<head>
    ...
    <title>Sistema de Monitoramento Prosional</title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form action="../../index2.html" method="post"><!--Falta correção -->
            ...
            <br>
            <a href="<?php echo site_url('SmpCadastro'); ?>" class="text-center">Cadastrar-se</a>
