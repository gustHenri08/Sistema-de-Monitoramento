...
CREATE TABLE `horarios` (
  `id` int(11) NOT NULL,
    `cadeia` varchar(220) NOT NULL,
  `nomepri` varchar(220) NOT NULL,
  `nomem` varchar(220) NOT NULL,
  `nomep` varchar(220) NOT NULL,
  `motivo` varchar(220) NOT NULL,
  `tipo` varchar(220) NOT NULL,
  `obs_gerais` varchar(220) NOT NULL,
...
INSERT INTO `horarios` (`id`, `datai`, `datas`) VALUES
(1, '2017-01-10 09:45:44', '2017-09-10 09:45:44'),
(2, '2017-01-23 09:00:32', '2017-09-23 09:00:32');
